...
public class Snapdeal 
{
	public static void main(String[] args) throws InterruptedException, IOException  
	{
		...
		String start = driver.findElement(By.xpath("//span[@class='from-price-text']")).getText();
		String end = driver.findElement(By.xpath("//span[@class='to-price-text']")).getText();
		if(start.contains("900") && end.contains("1200"))
		{
			System.out.println("The start and end value are verified");
		}
		
		boolean selected = driver.findElement(By.xpath("//label[@for='Color_s-Black']/preceding-sibling::input")).isSelected();
		if(selected)
		{	
